                    ...
                    <div class="modal-body">
                        <form id="add-company-form">
                            <div class="row">
                                ...
                                <div class="mb-3 col-6">
                                    <label for="bank_input" class="form-label">Bank</label>
                                    <select name="id_bank" class="form-select" aria-label="Default select example">
                                ...
                                <div class="mb-3 col-6">
                                    <label for="iban_input" class="form-label">IBAN</label>
                                    <input name="iban" type="text" class="form-control" id="iban_input">
                                </div>
                            </div>
                        </form>               
                    </div>
