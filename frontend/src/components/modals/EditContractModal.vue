            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5">Edit a contract</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="alert alert-danger" role="alert" v-if="alertMessage">{{ alertMessage }}</div>
                        <form id="edit-contract-form">
                            <div class="row">
                                <div class="mb-3 col-4">
                                    <label for="no_input" class="form-label">No.</label>
                                    <input name="no" id="no_input" type="text" class="form-control" :class="{'is-invalid': invalidFlags.no}" :value="contract.no" @input="removeInvalid('no')">
                                ...
                                <div class="mb-3 col-4">
                                    ...
                                    <input name="date" type="date" class="form-control" :class="{'is-invalid': invalidFlags.date || datesFlag}" :value="contract.date" @input="removeInvalid('date')">
                                ...
                                <div class="mb-3 col-4">
                                    ...
                                    <input name="expiration_date" type="date" class="form-control" :class="{'is-invalid': invalidFlags.expiration_date || datesFlag}" :value="contract.expiration_date" @input="removeInvalid('expiration_date')">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <select name="id_provider" class="form-select" :class="{'is-invalid': invalidFlags.id_provider}" :value="contract.id_provider" @input="removeInvalid('id_provider')">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <select name="id_beneficiary" class="form-select" :class="{'is-invalid': invalidFlags.id_beneficiary}" :value="contract.id_beneficiary" @input="removeInvalid('id_beneficiary')">
    ...
    export default {
        ...
        methods: {
            async getData() {
                ...
                this.contract.date = date.toLocaleDateString('fr-CA')

                date = new Date(this.contract.expiration_date)
                this.contract.expiration_date = date.toLocaleDateString('fr-CA')
            ...
            async modalSubmit(e) {
                ...
                if(!flagInvalidGeneral){
                    console.log(toSend)
                    await fetch("http://127.0.0.1:8000/api/editContract", {
                        method: "PUT",
                        headers: {
